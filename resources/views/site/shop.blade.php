    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
        <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
                        ...
                        <ul class="list list-inline mb-0 brand-list">
                            @foreach ($brands as $brand)
                                <li class="list-item">
                                    ...
                                    <span class="text-right float-end text-secondary">
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                ...
                <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="pagesize" id="pagesize" name="pagesize" style="margin-right: 20px">
                    <option value="12"{{ $size == 12 ? 'selected' : '' }}>Show </option>
                    <option value="24"{{ $size == 24 ? 'selected' : '' }}>24</option>
                    <option value="48"{{ $size == 48 ? 'selected' : '' }}>48</option>
                    <option value="102"{{ $size == 102 ? 'selected' : '' }}>120</option>
                </select>
                ...
                @foreach ($products as $product)
                    <div class="product-card-wrapper">
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            ...
                            <h6 class="pc__title"><a href="{{ route('shop.product.details',$product->slug) }}"></a></h6>
...
<form id="frmfilter" method="GET" action="{{ route('shop') }}">
    ...
    <input type="hidden" id="hdnBrands" name="brands" value="{{ $order }}">
</form>
