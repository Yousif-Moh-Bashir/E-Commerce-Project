    ...
    <section class="product-single container">
        ...
        <div class="col-lg-7">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide product-single__image-item">
                            <img loading="lazy" class="h-auto" src="{{ asset('assets/uploads/product/'.$product->image) }}" width="674" height="674" alt="" />
                            <a data-fancybox="gallery" href="{{ asset('assets/uploads/product/'.$product->image) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                        ...
                        @foreach (explode(',',$product->images) as $gimage)
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="{{ asset('assets/uploads/product/'.$gimage) }}" width="674" height="674" alt="{{ $product->name }}" />
                                <a data-fancybox="gallery" href="{{ asset('assets/uploads/product/'.$gimage) }}" data-bs-toggle="tooltip"
            ...
            <div class="product-single__thumbnail">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{ asset('assets/uploads/product/thumbnail/'.$product->image) }}" width="104" height="104" alt="{{ $product->name }}" /></div>
                        @foreach (explode(',',$product->images) as $gimage)
                            <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{ asset('assets/uploads/product/thumbnail/'.$gimage) }}" width="104" height="104" alt="{{ $product->name }}" /></div>
                        @endforeach
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5">
            ...
            <span class="current-price">
                @if ($product->sale_price)
                    <s style="color: #767171;">${{ $product->regular_price }} </s> ${{ $product->sale_price }}
                @else
                    ...
                    @foreach ($related_products as $related_product)
                        <div class="swiper-slide product-card">
                            <div class="pc__img-wrapper">
                                <a href="{{ route('shop.product.details',$related_product->slug) }}">
                                    <img loading="lazy" src="{{ asset('assets/uploads/product/'.$related_product->image) }}" width="330" height="400" alt="{{ $related_product->name }}" class="pc__img">
                                    @foreach (explode(',',$related_product->images) as $gimage)
                                        <img loading="lazy" src="{{ asset('assets/uploads/product/'.$gimage) }}" width="330" height="400" alt="{{ $related_product->name }}" class="pc__img pc__img-second">
                                    @endforeach
                                </a>
                                <button
                            ...
                            <h6 class="pc__title"><a href="{{ route('shop.product.details',$related_product->slug) }}">{{ $related_product->name }}t</a></h6>
