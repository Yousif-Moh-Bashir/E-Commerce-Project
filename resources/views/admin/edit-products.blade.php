                ...
                <div class="wg-box">
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <textarea class="mb-10 ht-150" name="short_description"
                            placeholder="Short Description" tabindex="0" aria-required="true" required="">{{ old('short_description',$product->short_description) }}</textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                    </fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            @if ($product->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset('assets/uploads/product') }}/{{ $product->image }}" class="effect8" alt="{{ $product->name }}">
                                </div>
                            @endif
                            ...
                            @if ($product->images)
                                @foreach (explode(',',$product->images) as $img)
                                    <div class="item gitems">
                                        <img src="{{ asset('assets/uploads/product') }}/{{ trim($img) }}" alt="">
                                    </div>
                                @endforeach
                            @endif
